...
Adding the ``published`` class to an ``input-group`` bootstrap component will allow the ``input-group-addon`` elements to trigger the picker.

.. code-block:: html

    <div class="input-group published">
...
.. code-block:: html
    ...
    <div data-published="12/03/2012"></div>
...
.. code-block:: html
    ...
    <div id="datepicker" data-published="12/03/2012"></div>
