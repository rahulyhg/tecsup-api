    ...
    class FormBuilder 
      def date_select(method, options = {}, html_options = {})
        ...
        @template.content_tag(:div, :class => "input-group") do    
          text_field(method, :value => formatted_date, :class => "form-control datepicker", :"data-published-format" => "YYYY-MM-DD") +
      ...
      def datetime_select(method, options = {}, html_options = {})
        ...
        @template.content_tag(:div, :class => "input-group") do    
          text_field(method, :value => formatted_time, :class => "form-control datetimepicker", :"data-published-format" => "YYYY-MM-DD hh:mm A") +
          @template.content_tag(:span, @template.content_tag(:span, "", :class => "glyphicon glyphicon-calendar") ,:class => "input-group-addon")
        end
      end
    end
...
If you open the datetimepicker widget and click on some button or published inside it, widget is automatically closed.
